export { Map, LngLat, Marker, Pixel, Size, Icon, Label, ToolBar, InfoWindow, Polyline } from './core/interfaces/amap.interface';
...
export { PolylineOptions } from './core/interfaces/amap.polyline-options';
