...
@Component({
  selector: 'demo-amap-marker-cluster-simple',
  templateUrl: './demo-amap-marker-cluster-simple.component.html',
  styleUrls: ['./demo-amap-marker-cluster-simple.component.scss'],
})
export class DemoAmapMarkerClusterSimpleComponent implements OnInit {
  html = require('!!html-loader!./demo-amap-marker-cluster-simple.component.html'); // DEMO IGNORE
  component = require('!!raw-loader!./demo-amap-marker-cluster-simple.component.ts').default; // DEMO IGNORE
  markers = [
