...
@Component({
  selector: 'demo-amap-marker-cluster-events',
  templateUrl: './demo-amap-marker-cluster-events.component.html',
  styleUrls: ['./demo-amap-marker-cluster-events.component.scss'],
})
export class DemoAmapMarkerClusterEventsComponent implements OnInit {
  html = require('!!html-loader!./demo-amap-marker-cluster-events.component.html'); // DEMO IGNORE
  component = require('!!raw-loader!./demo-amap-marker-cluster-events.component.ts').default; // DEMO IGNORE
  markers = [
